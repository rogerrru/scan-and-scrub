...
const Header = () => {
  ...
  return (
    <header className="font-sserif text-sm text-[#5A5959] w-full flex justify-between items-center py-3 px-6 md:px-20 z-50">
      ...
      <nav className={`absolute md:static top-16 left-0 w-full md:w-auto bg-[#F4F5F9] md:bg-transparent shadow-md md:shadow-none transition-all duration-300 ${menuOpen ? "block" : "hidden"} md:flex justify-end`}>
